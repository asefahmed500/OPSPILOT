...
export default async function SystemHealthPage() {
  ...
  const aiConfigured = Boolean(env.HCNSEC_API_KEY)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <HealthCard label="AI provider" status={aiConfigured ? "healthy" : "attention"} detail={aiConfigured ? `Configured with HCNSEC model ${aiModel}.` : "Missing HCNSEC_API_KEY."} />
